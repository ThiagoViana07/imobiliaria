...
const validateVendedorInput = (vendedor) => {
    ...
    if (typeof vendedor.cpf !== "string" || vendedor.cpf.length !== 11 || !/^\d+$/.test(vendedor.cpf)) {
    ...
    if (typeof vendedor.telefone !== "string" || vendedor.telefone.length < 10 || !/^\d+$/.test(vendedor.telefone)) {
...
const validateVendedorUpdateInput = (updateData) => {
    ...
    if (updateData.cpf !== undefined) {
        if (typeof updateData.cpf !== "string" || updateData.cpf.length !== 11 || !/^\d+$/.test(updateData.cpf)) {
            errors.push("CPF deve ser uma string contendo exatamente 11 números.");
        }
    }

    if (updateData.telefone !== undefined) {
        if (typeof updateData.telefone !== "string" || updateData.telefone.length < 10 || !/^\d+$/.test(updateData.telefone)) {
